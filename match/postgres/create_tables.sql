...
-- INSERT INTO rooms(room_id, task_private_ip) VALUES('-1000', 'test-ip-1:5000'); -- These should be removed after deployment
-- INSERT INTO rooms(room_id, task_private_ip) VALUES('-1001', 'test-ip-2:5000');